...
"-C(=O)S-",0,0,0,"C(=O)[S;H0;X2][C,c,N,n]","1|2","thioester",
"-C(=O)S",1,0,0,"C(=O)[S;H1;X2;+0]","1|2","thiocarboxyl",
"-C(=O)S",0,-1,0,"C(=O)[S;H0;X1;-1]","1|2","thiocarboxyl",
...
"ring =n<",0,0,0,"[n;H0;X3;+0]","All","double bond and one single bond participating in a ring",
"ring -n=",1,1,0,"[n;H1;X3;+1]","All","participating in a ring",
"ring -n=",0,0,0,"[n;H0;X2;+0]","All","participating in a ring",
"ring -n-",1,0,0,"[n;H1;X3;+0]","All","participating in a ring",
"ring -n-",0,-1,0,"[n;H0;X2;-1]","All","participating in a ring",
...
"CO-N",2,0,0,"C(=O)[N;H2;0]","All","primary amine next to keto","skip"
"CO-N",1,-1,0,"C(=O)[N;H1;-1]","All","primary amine next to keto","skip"
"-N",3,1,0,"[C,N,O,S,P][N;H3;X4;+1]","1","primary amine",
"-N",2,0,0,"[C,N,O,S,P][N;H2;X3;+0]","1","primary amine",
"-N",1,-1,0,"[C,N,O,S,P][N;H1;X2;-1]","1","primary amine",
...
"two fused rings >C<",0,0,0,"[C;H0;R2]([C,N])([C,N])([C,N])[C,N]",0,"quaternary carbon participating in two fused nonaromatic rings",
"two fused rings -C<",1,0,0,"[C;H1;R2]([C,N])([C,N])[C,N]",0,"tertiary carbon participating in two fused nonaromatic rings",
"two fused rings =C<",0,0,0,"[C;H0;R2](=[C,N])([C,N])[C,N]",0,"participating in two fused nonaromatic rings",
"two fused rings -C-",2,0,0,"[C;H2;R2;X4]","All","secondary carbon (participating in two fused rings)",
"two fused rings =c<",0,0,0,"[c;R2]","All","participating in two fused aromatic rings",
"ring =cH-",1,0,0,"[c;H1;R1]","All","participating in one aromatic ring",
"ring >c=",0,0,0,"[c;H0;R1]","All","one single bond and one double bond participating in an aromatic ring",
"ring >C=",0,0,0,"[C;H0;R1;X3]","All","one single bond and one double bond participating in a nonaromatic ring",
"ring =C-",1,0,0,"[C;H1;R1;X3]","All","participating in a nonaromatic ring",
"=C-",1,0,0,"[C;H1;X3]","All",,
"=C",2,0,0,"[C;H2;X3]","All",,
"=C<",0,0,0,"[C;H0;X3]","All",,
"ring >C<",0,0,0,"[C;H0;R1;X4]","All","quaternary carbon (participating in one ring)",
"ring -C<",1,0,0,"[C;H1;R1;X4]","All","tertiary carbon (participating in one ring)",
"ring -C-",2,0,0,"[C;H2;R1;X4]","All","secondary carbon (participating in one ring)",
"-C",3,0,0,"[C;H3;X4]","All","methyl",
"-C-",2,0,0,"[C;H2;X4]","All","secondary carbon",
"-C<",1,0,0,"[C;H1;X4]","All","tertiary carbon",
">C<",0,0,0,"[C;H0;X4]","All","quaternary carbon",
"OCCC conjugation correction",0,0,0,"O=CC=C","None","OCCC conjugation correction","skip"
"OCCO conjugation correction",0,0,0,"O=CC=O","None","OCCO conjugation correction","skip"
"OCCN conjugation correction",0,0,0,"O=CC=N","None","OCCN conjugation correction (currently no examples)","skip"
"CCCN conjugation correction",0,0,0,"C=CC=N","None","CCCN conjugation correction (currently no examples)","skip"
"CCCC conjugation correction",0,0,0,"C=CC=C","None","CCCC conjugation correction (currently no examples)","skip"
"NC(=N)N correction",0,0,0,"NC(=N)N","None","guanidine correction",
"vicinal Cl correction",0,0,0,"Cl~C~C~Cl","None","vicinal Cl correction (not 100% accurate, but currently no examples)","skip"
"amide correction",0,0,0,"C(=O)[N;R0]C","None","amide bond correction",
"thioester correction",0,0,0,"CSC(=O)C","None","thioester correction (linearly dependent on CoA)","skip"
"three member ring correction",0,0,0,"*1**1","None","three member ring correction (currently no examples)","skip"
"*Hc",0,0,0,"[!C;!c]","None","hydrocarbon correction (expanded in code)","skip"
"*Ar",0,0,0,"c1cccc1","None","aromatic ring correction (expanded in code)","skip"
