...
class InChI2FormationEnergy(object):
    ...
    def __init__(self, group_fname, g_pgc_fname, P_L_pgc_fname):
        self.RT = R * default_T
        self.groups_data = GroupsData.FromGroupsFile(group_fname, transformed=False)
...
def Init():
    return InChI2FormationEnergy('groups_species.csv', 'g_pgc.gz.npy', 'P_L_g_pgc.gz.npy')
